...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class IdentityServerApplicationBuilderExtensions
    {
        ...
        internal static void Validate(this IApplicationBuilder app)
        {
            ...
            logger.LogInformation("Starting IdentityServer4Plus version {version}", typeof(IdentityServer4.Hosting.IdentityServerMiddleware).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion);
