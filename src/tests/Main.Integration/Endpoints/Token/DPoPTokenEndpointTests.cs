...
public class DPoPTokenEndpointTests
{
    ...
    string _jwt = "JGSVlE73oKtQQI1dypYg8_JNat0xJjsQNyOI5oxaZf4";
    ...
    void CreateNewRSAKey()
    {
        ...
        _jwt = Base64UrlEncoder.Encode(key.ComputeJwkThumbprint());
    ...
    public async Task Valid_dpop_request_should_return_bound_refresh_token()
    {
        ...
        GetJKTFromAccessToken(codeResponse).Should().Be(_jwt);
        ...
        GetJKTFromAccessToken(rtResponse).Should().Be(_jwt);
    }
    ...
    public async Task Public_client_using_same_dpop_key_for_refresh_token_request_should_succeed()
    {
        ...
        GetJKTFromAccessToken(firstRefreshResponse).Should().Be(_jwt);
        ...
        GetJKTFromAccessToken(secondRefreshResponse).Should().Be(_jwt);
    }
    ...
    public async Task Valid_dpop_request_using_reference_token_at_introspection_should_return_binding_information()
    {
        ...
        GetJKTFromCnfClaim(introspectionResponse.Claims).Should().Be(_jwt);
    }
