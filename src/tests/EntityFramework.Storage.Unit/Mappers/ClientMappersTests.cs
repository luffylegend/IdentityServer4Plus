...
public class ClientMappersTests
{
    ...
    public void Duplicates_properties_in_db_map()
    {
        ...
        {
            Properties = new System.Collections.Generic.List<IdentityServer4.EntityFramework.Entities.ClientProperty>()
        {
            new IdentityServer4.EntityFramework.Entities.ClientProperty{Key = "foo1", Value = "bar1"},
            new IdentityServer4.EntityFramework.Entities.ClientProperty{Key = "foo1", Value = "bar2"},
        }
        };
