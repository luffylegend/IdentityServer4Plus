...
public static class MapperTestHelpers
{
    ...
    {
        return AllPropertiesAreMapped(DefaultConstructor<TSource>(), _noExclusions, EmptyCustomization<TSource>(), mapper, Array.Empty<string>(), out unmappedMembers);
    }
    ...
    public static bool AllPropertiesAreMapped<TSource, TDestination>(
        ...
        out List<string> unmappedMembers)
    {
        return AllPropertiesAreMapped(creator, _noExclusions, EmptyCustomization<TSource>(), mapper, _noExclusions, out unmappedMembers);
    }
    ...
    public static bool AllPropertiesAreMapped<TSource, TDestination>(
        ...
        out List<string> unmappedMembers)
    {
        return AllPropertiesAreMapped(DefaultConstructor<TSource>(), _noExclusions, customizer, mapper, Array.Empty<string>(), out unmappedMembers);
    }
    ...
    public static bool AllPropertiesAreMapped<TSource, TDestination>(
        ...
        out List<string> unmappedMembers)
    {
        return AllPropertiesAreMapped(DefaultConstructor<TSource>(), _noExclusions, EmptyCustomization<TSource>(), mapper, notMapped, out unmappedMembers);
    }
    ...
    public static bool AllPropertiesAreMapped<TSource, TDestination>(
        ...
        out List<string> unmappedMembers)
    {
        return AllPropertiesAreMapped(DefaultConstructor<TSource>(), _noExclusions, customizer, mapper, notMapped, out unmappedMembers);
    }
    ...
    public static bool AllPropertiesAreMapped<TSource, TDestination>(
        ...
        out List<string> unmappedMembers)
    {
        return AllPropertiesAreMapped(creator, _noExclusions, customizer, mapper, _noExclusions, out unmappedMembers);
    }
    ...
    public static bool AllPropertiesAreMapped<TSource, TDestination>(
        ...
        out List<string> unmappedMembers)
    {
        return AllPropertiesAreMapped(creator, _noExclusions, EmptyCustomization<TSource>(), mapper, notMapped, out unmappedMembers);
    }
    ...
    private static string[] _noExclusions = Array.Empty<string>();
}
