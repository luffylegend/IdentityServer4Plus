...
namespace IdentityServer.UnitTests.Validation
{
    public class StrictRedirectUriValidatorAppAuthValidation
    {
        ...
        private Client _clientWithValidLoopbackRedirectUri = new Client
        {
            RequirePkce = true,
        ...
        private Client _clientWithNoRedirectUris = new Client
        {
            RequirePkce = true
        };
        ...
        public async Task Loopback_Redirect_URIs_Should_Be_AllowedAsync(string requestedUri)
        {
            ...
            var result = await strictRedirectUriValidatorAppAuthValidator.IsRedirectUriValidAsync(requestedUri, _clientWithValidLoopbackRedirectUri);
