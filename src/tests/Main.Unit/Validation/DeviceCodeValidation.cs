...
namespace IdentityServer.UnitTests.Validation
{
    public class DeviceCodeValidation
    {
        ...
        public async Task DeviceCode_From_Different_Client()
        {
            ...
            var handle = await service.StoreDeviceAuthorizationAsync(Guid.NewGuid().ToString(), _deviceCode);
        ...
        {
            _deviceCode.CreationTime = DateTime.UtcNow.AddDays(-10);
            _deviceCode.Lifetime = 300;
        ...
        {
            _deviceCode.AuthorizedScopes = new List<string>();
        ...
        {
            _deviceCode.IsAuthorized = false;
