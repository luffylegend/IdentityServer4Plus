...
public interface IPersistedGrantDbContext : IDisposable
{
    ...
    // this is here only because of this: IPersistedGrantDbContext.SaveChangesAsync(CancellationToken cancellationToken = default) not implemented by AspnetCore .NET 6-rc.2.21480.5
