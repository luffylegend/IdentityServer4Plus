...
namespace IdentityServer4.AccessToken.OpenIdConnect;
...
public static class OpenIdConnectTokenManagementDefaults
{
    ...
    /// </summary>
    public const string ClientCredentialsClientNamePrefix = "IdentityServer4.AccessToken.SchemeBasedClient:";
}
