    ...
    public readonly static IEnumerable<string> SupportedSigningAlgorithms = new List<string>
{
    ...
    {
        public static readonly string Basic = IdentityServer4.Tracing.TraceNames.Basic;
        public static readonly string Stores = IdentityServer4.Tracing.TraceNames.Store;
        public static readonly string Cache = IdentityServer4.Tracing.TraceNames.Cache;
        public static readonly string Validation = IdentityServer4.Tracing.TraceNames.Validation;
        public static readonly string Services = IdentityServer4.Tracing.TraceNames.Services;

        public static readonly string ServiceVersion = IdentityServer4.Tracing.ServiceVersion;
    }
