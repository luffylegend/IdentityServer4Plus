...
internal class IdentityServerLicenseValidator : LicenseValidator<IdentityServerLicense>
{
    ...
    bool _validateServerSideSessionsWarned = false;
    public void ValidateServerSideSessions()
    {
        if (License != null)
        {
            ...
            {
                throw new Exception("You have configured server-side sessions. Your license for IdentityServer4 does not include that feature. This feature requires the Business or Enterprise Edition tier of license.");
            }
        }
        else if (!_validateServerSideSessionsWarned)
        {
            _validateServerSideSessionsWarned = true;
    ...
    public void ValidateDPoP()
    {
        if (License != null)
        {
            ...
            {
                throw new Exception("A request was made using DPoP. Your license for IdentityServer4 does not include the DPoP feature. This feature requires the Enterprise Edition tier of license.");
            }
        }
        else if (!_canUseDPoPWarned)
        {
            _canUseDPoPWarned = true;
    ...
    bool _validateResourceIndicatorsWarned = false;
    public void ValidateResourceIndicators(string resourceIndicator)
    {
        if (!String.IsNullOrWhiteSpace(resourceIndicator))
        {
            if (License != null)
            {
                ...
                {
                    throw new Exception("A request was made using a resource indicator. Your license for IdentityServer4 does not permit resource isolation. This feature requires the Enterprise Edition tier of license.");
                }
            }
            else if (!_validateResourceIndicatorsWarned)
            {
                _validateResourceIndicatorsWarned = true;
    ...
    public void ValidatePar()
    {
        if (License != null)
        {
            ...
            {
                throw new Exception("A request was made to the pushed authorization endpoint. Your license of IdentityServer4 does not permit pushed authorization. This features requires the Business Edition or higher tier of license.");
            }
        }
        else if (!_validateParWarned)
        {
            _validateParWarned = true;
    ...
    bool _validateDynamicProvidersWarned = false;
    public void ValidateDynamicProviders()
    {
        if (License != null)
        {
            ...
            {
                throw new Exception("A request was made invoking a dynamic provider. Your license for IdentityServer4 does not permit dynamic providers. This feature requires the Enterprise Edition tier of license.");
            }
        }
        else if (!_validateDynamicProvidersWarned)
        {
            _validateDynamicProvidersWarned = true;
    ...
    bool _validateCibaWarned = false;
    public void ValidateCiba()
    {
        if (License != null)
        {
            ...
            {
                throw new Exception("A CIBA (client initiated backchannel authentication) request was made. Your license for IdentityServer4 does not permit the CIBA feature. This feature requires the Enterprise Edition tier of license.");
            }
        }
        else if (!_validateCibaWarned)
        {
            _validateCibaWarned = true;
