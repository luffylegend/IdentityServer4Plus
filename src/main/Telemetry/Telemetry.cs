...
public static class Telemetry
{
    ...
    /// <summary>
    /// Service name used for IdentityServer4.
    /// </summary>
    public const string ServiceName = "IdentityServer4";

    /// <summary>
    /// Service name used for the experimental non stable counters from IdentityServer4
    /// </summary>
    public const string ServiceNameExperimental = "IdentityServer4.Experimental";
