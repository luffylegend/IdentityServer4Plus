...
internal static class Program
{
    ...
    static async Task Main(string[] args)
    {
        ...
        Target(Targets.Pack, DependsOn(Targets.Build, Targets.CleanPackOutput), () =>
        {
            ...
            Run("dotnet", $"pack \"src/main/AccessToken/IdentityServer4Plus.AccessToken.csproj\" -c Release -o \"{directory}\" --no-build --nologo");
            Run("dotnet", $"pack \"src/main/AccessToken.OpenIdConnect/IdentityServer4Plus.AccessToken.OpenIdConnect.csproj\" -c Release -o \"{directory}\" --no-build --nologo");
            ...
            Run("dotnet", $"pack \"src/Configuration/IdentityServer4Plus.Configuration.csproj\" -c Release -o \"{directory}\" --no-build --nologo");
            Run("dotnet", $"pack \"src/EntityFramework.Configuration/IdentityServer4Plus.EntityFramework.Configuration.csproj\" -c Release -o \"{directory}\" --no-build --nologo");
